                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-action-group">
                                    ...
                                    <a href="hapus.php?id=<?php echo $kdr['id_kendaraan']; ?>" class="btn btn-danger btn-sm p-1 px-2" onclick="return confirm('Apakah Anda yakin ingin menghapus kendaraan ini?');" title="Hapus">
