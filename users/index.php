                            ...
                            <td>
                                <div class="btn-action-group">
                                    ...
                                    <?php if ($user['id_user'] != $_SESSION['id_user']): ?>
                                        <a href="hapus.php?id=<?php echo $user['id_user']; ?>" class="btn btn-danger btn-sm p-1 px-2" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?');" title="Hapus">
