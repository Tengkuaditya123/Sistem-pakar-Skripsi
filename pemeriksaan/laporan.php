                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-action-group justify-content-center">
                                    <!-- Aksi: Hapus Laporan -->
                                    <a href="laporan.php?action=hapus&id=<?php echo $row['id_pemeriksaan']; ?>" class="btn btn-danger btn-sm p-1 px-2" onclick="return confirm('Apakah Anda yakin ingin menghapus data laporan ini?');" title="Hapus">
