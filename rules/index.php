        ...
        <table class="datatable table table-hover align-middle table-borderless w-100">
            ...
            <tbody>
                ...
                if (count($grouped_rules) > 0) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-action-group">
                                    ...
                                    <a href="hapus.php?kode=<?php echo urlencode($rule['kode_rule']); ?>" class="btn btn-danger btn-sm p-1 px-2" onclick="return confirm('Apakah Anda yakin ingin menghapus rule <?php echo htmlspecialchars($rule['kode_rule']); ?>?');" title="Hapus">
                    ...
                    echo "<tr><td colspan='6' class='text-center text-muted p-4'>Tidak ada data rule ditemukan.</td></tr>";
                }
                ?>
            </tbody>
        </table>
